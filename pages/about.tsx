    ...
    <>
      <section id="about">
        ...
        <p>
          ...
          in the power of simplicity and strive to design environments that are
          both beautiful and practical, enhancing the quality of life for our
          clients.
        </p>
        <p>
        ...
        <p>
          ...
          and a meticulous attention to detail. We collaborate closely with our
          clients to ensure that every project is tailored to their unique
        ...
        <p>
          ...
          eco-friendly materials and techniques in all our projects. Our goal is
          to create spaces that not only look good but also feel good, promoting
