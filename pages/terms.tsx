  ...
  return (
    <>
      <section id="terms">
        ...
        <h2>Your Account</h2>
        <p>
          You may need an account in order to use some of our services. You are
          responsible for protecting your account by keeping your password
        ...
        <p>
          ...
          necessarily mean that we review content, so please do not assume that
          we do.
        </p>
        ...
        <p>
          ...
          expressly set out in these terms or additional terms, neither we nor
          our suppliers or distributors make any specific promises about the
          services. For example, we don’t make any commitments about the content
          within the services, the specific functions of the services, or their
          reliability, availability, or ability to meet your needs. We provide
          the services “as is”.
        </p>
        <h2>Liability for Our Services</h2>
        <p>
          When permitted by law, we, and our suppliers and distributors, will
          ...
          damages. To the extent permitted by law, the total liability of us,
          and our suppliers and distributors, for any claims under these terms,
        ...
        <p>
          ...
          of the State of [Your State], without regard to its conflict of law
          principles. You agree to submit to the jurisdiction of the courts
          located within [Your State] for the resolution of any disputes arising
          from these terms or the use of our services.
        </p>
        <h2>Contact Us</h2>
        <p>
